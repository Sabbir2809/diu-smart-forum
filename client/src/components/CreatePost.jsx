    ...
    try {
      ...
      createPostFunc({
        ...
        if (error) {
          ...
          setDisableSubmit(true);
          setAlertMessage(
            'Post created successfully! Please wait you will be automatically redirected to home page...'
          );
          setIsError(false);
          setSubmitted(false);
            ...
            {file !== null ? (
              <div className='uploaded-document-details'>
                ...
                <BootstrapTooltip title='View file' placement='top'>
                  <div onClick={() => setOpenPreview(true)} className='file-name'>
                    {file.name}
                  </div>
                </BootstrapTooltip>
              ...
              <div className='uploaded-document-details'>
                <BootstrapTooltip title='Please upload a file to continue' placement='top'>
