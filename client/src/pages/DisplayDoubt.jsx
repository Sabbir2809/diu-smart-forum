...
import { Avatar, CircularProgress, Button, Chip, IconButton } from '@mui/material';
                    ...
                    <div className='votes_wrappper'>
                      <Button
                        ...
                        className={`custom_btn active ${
                          requestedDoubt?.doubtData?.upVotes?.indexOf(user?._id) === -1
                            ? 'black_dull'
                            : 'black'
                        }`}>
                      ...
                      <Button
                        ...
                        className={`custom_btn active ${
                          requestedDoubt?.doubtData?.downVotes?.indexOf(user?._id) === -1
                            ? 'black_dull'
                            : 'black'
                        }`}>
