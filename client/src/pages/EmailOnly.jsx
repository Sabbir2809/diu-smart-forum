...
const EmailOnly = () => {
  ...
  const handleResetPassword = (e) => {
    ...
    newPasswordRequestFunc({ email: inputEmail }).then(async ({ data, error }) => {
      if (error) {
        setIsError(true);
    ...
    <div className='email-outer'>
      ...
      <div className='flex-center-wrapper row-gap-2'>
        ...
        <div className='info-paragraph'>
          An verification mail will be sent to the email provided by you. Please reset your password within 2
          hours of time limit otherwise link will be expired.
        </div>
        <div onSubmit={handleResetPassword} className='input-item'>
          ...
          <div className='button-group'>
            ...
            <Button disabled={disableSubmit} onClick={handleResetPassword}>
              {disableSubmit ? <CircularProgress style={{ width: '20px', height: '20px' }} /> : 'Send Email'}
            </Button>
          </div>
        </div>
      </div>
