...
const ResetPassword = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    await resetPasswordFunc({ token: token, newPassword: password }).then(({ data, error }) => {
      if (error) {
        setIsError(true);
      ...
      <div className='signup-wrapper'>
        <div className='flex-center-wrapper row-gap-2'>
          ...
          <div className='reset-info-paragraph'>
            We recommend to type in strong password of minimum length 8 with lower case, upper case and some
            special characters to keep your account safe.
          </div>
